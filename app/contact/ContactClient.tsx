...
export default function ContactPage() {
  ...
  const formSchema = z.object({
    ...
    subject: z
      .string()
      .min(5, { message: t("contact.validation.subjectRequired") }),
    message: z
      .string()
      .min(10, { message: t("contact.validation.messageRequired") }),
  });
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      const response = await fetch(
        "https://mytaskly-site-server-production.up.railway.app/message",
        {
          method: "POST",
          headers: {
