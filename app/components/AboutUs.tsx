  ...
  return (
    <section className="py-20 px-4 sm:px-6 lg:px-8 bg-secondary">
      <div className="container mx-auto">
        <motion.h2
          className="text-5xl font-black mb-8 text-center text-secondary-foreground"
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <motion.div initial={{ opacity: 0, x: -50 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }}>
            <h3 className="text-3xl font-bold mb-4 text-secondary-foreground">We are Creative Innovators</h3>
          ...
          >
            ...
            <div className="absolute inset-0 bg-secondary/80 rounded-lg transform -rotate-3 flex items-center justify-center">
              <p className="text-2xl font-bold text-secondary-foreground">Creative Team at Work</p>
            </div>
          </motion.div>
        </div>
      </div>
