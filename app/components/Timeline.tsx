      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <ScrollAnimationWrapper>
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-lg text-muted-foreground">{t("timeline.subtitle")}</p>
          </div>
        </ScrollAnimationWrapper>
  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        onClick={onToggle}
      >
        <div className="bg-card text-card-foreground p-4 rounded-lg shadow-md border border-primary/10">
