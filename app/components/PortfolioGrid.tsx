...
export default function PortfolioGrid() {
  ...
  const projects: Project[] = [
    ...
    },
    {
      ...
      title: t("portfolio.tasks.title"),
      description: t("portfolio.tasks.description"),
      icon: NotebookPen,
    ...
    },
    {
      id: 3,
      slug: "notifications",
      title: t("portfolio.notifications.title"),
      description: t("portfolio.notifications.description"),
      icon: Brain,
      category: t("category.core"),
    },
    {
    ...
    },
    {
      id: 5,
      slug: "offline-sync",
      title: t("portfolio.sync.title"),
      description: t("portfolio.sync.description"),
      icon: Zap,
      category: t("category.integration"),
    },
    {
